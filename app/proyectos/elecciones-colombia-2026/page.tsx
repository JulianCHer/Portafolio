...
export default function EleccionesColombia() {
    const { t } = useLanguage();
            ...
            <div className="max-w-7xl mx-auto w-full mt-10 space-y-20 pb-32">
                ...
                <section className="flex flex-col xl:flex-row items-center justify-between gap-16 w-full">
                    ...
                    <div className="flex flex-col items-center text-center xl:items-start xl:text-left space-y-8 w-full xl:w-5/12">
                        ...
                        >
                            {renderHighlightedText(t("projects.elections.desc"))}
                        </motion.p>
                        ...
                        <div className="flex flex-col gap-4 w-full max-w-xl">
                            ...
                            <motion.div
                                ...
                                className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md w-full hover:bg-white/10 transition-colors group/card"
                            >
                    ...
                    >
                        ...
                        >
                            ...
                            <Safari
                                url="elections-colombia.vercel.app"
                ...
                >
                    ...
                    <div className="max-w-md text-center md:text-left">
                        ...
                        <p className="text-gray-400 text-lg leading-relaxed mb-6 text-justify">
                            {t("projects.elections.responsive.desc")}
                        </p>
